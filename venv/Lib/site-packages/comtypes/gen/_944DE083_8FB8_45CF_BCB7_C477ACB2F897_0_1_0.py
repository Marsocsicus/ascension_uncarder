...
__all__ = [
    ...
    'NotificationProcessing_All', 'ProviderOptions_UseComThreading',
    'AnnotationType_EditingLockedChange', 'UIA_InvokePatternId',
    'IUIAutomationSpreadsheetItemPattern',
    'UIA_InputReachedTargetEventId', 'UIA_RuntimeIdPropertyId',
    'IUIAutomation4', 'UIA_Transform2ZoomMaximumPropertyId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'StructureChangeType_ChildRemoved', 'UIA_StyleIdAttributeId',
    'UIA_ListControlTypeId', 'IUIAutomation6', 'HeadingLevel7',
    'UIA_IsGridPatternAvailablePropertyId',
    'UIA_ComboBoxControlTypeId', 'AnnotationType_Author',
    'UIA_IsValuePatternAvailablePropertyId',
    'UIA_ObjectModelPatternId', 'IUIAutomationElementArray',
    'UIA_IsContentElementPropertyId',
    'NotificationProcessing_ImportantAll',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'UIA_IsScrollPatternAvailablePropertyId', 'DockPosition_None',
    'UIA_Text_TextChangedEventId', 'CUIAutomation8',
    'TreeScope_Ancestors', 'TreeTraversalOptions_PostOrder',
    'UIA_MenuModeEndEventId', 'AnnotationType_FormulaError',
    'StyleId_Normal', 'UIA_WindowPatternId',
    'UIA_DragDropEffectPropertyId', 'UIA_SizeOfSetPropertyId',
    'UIA_AnnotationObjectsAttributeId',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'UIA_FlowsFromPropertyId', 'UIA_IsDockPatternAvailablePropertyId',
    'TextPatternRangeEndpoint_Start', 'UIA_PaneControlTypeId',
    ...
    'UIA_HorizontalTextAlignmentAttributeId', 'TreeScope_Subtree',
    'IUIAutomationWindowPattern', 'UIA_Drag_DragCancelEventId',
    'ToggleState_On', 'IUIAutomationTextPattern2', 'TreeScope_Parent',
    'UIA_StylesFillPatternStylePropertyId', 'UIA_ScrollPatternId',
    'UIA_StrikethroughColorAttributeId',
    'IUIAutomationStructureChangedEventHandler', 'HeadingLevel8',
    'UIA_LegacyIAccessibleRolePropertyId',
    'NotificationKind_ActionAborted', 'UIA_DataGridControlTypeId',
    'SynchronizedInputType_RightMouseUp',
    'ConnectionRecoveryBehaviorOptions', 'AnnotationType_MoveChange',
    'IUIAutomationElement7', 'UIA_AnnotationObjectsPropertyId',
    'IUIAutomationExpandCollapsePattern', 'ScrollAmount_NoAmount',
    ...
    'UIA_FontSizeAttributeId', 'StyleId_NumberedList',
    'IUIAutomationDragPattern',
    'TreeTraversalOptions_LastToFirstOrder', 'UIA_GroupControlTypeId',
    'WindowInteractionState_BlockedByModalWindow',
    'ProviderOptions_ServerSideProvider', 'HeadingLevel5',
    'UIA_StrikethroughStyleAttributeId',
    'UIA_IsWindowPatternAvailablePropertyId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_LegacyIAccessibleNamePropertyId', 'StyleId_Custom',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_OutlineColorPropertyId', 'UIA_TableColumnHeadersPropertyId',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'UIA_Selection2ItemCountPropertyId', 'WindowVisualState_Normal',
    'UIA_SayAsInterpretAsAttributeId', 'IUIAutomationElement8',
    'UIA_LegacyIAccessibleChildIdPropertyId', 'StyleId_Heading7',
    'UIA_DragPatternId', 'ExpandCollapseState_Expanded',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'UIA_ProgressBarControlTypeId', 'TextUnit_Page', 'TextUnit_Word',
    'IUIAutomationLegacyIAccessiblePattern',
    'UIA_LegacyIAccessibleDescriptionPropertyId', 'StyleId_Heading2',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_MarginTrailingAttributeId', 'IUIAutomationCacheRequest',
    'WindowInteractionState', 'AnnotationType_AdvancedProofingIssue',
    'IUIAutomationAndCondition', 'UIA_ProcessIdPropertyId',
    'IUIAutomationInvokePattern',
    'IUIAutomationTextEditTextChangedEventHandler',
    'UIA_LineSpacingAttributeId', 'IUIAutomationTableItemPattern',
    'UIA_OptimizeForVisualContentPropertyId', 'UIA_ChangesEventId',
    'UIA_CenterPointPropertyId',
    'PropertyConditionFlags_MatchSubstring',
    'UIA_DragDropEffectsPropertyId', 'UIA_AnnotationTypesAttributeId',
    'UIA_CheckBoxControlTypeId',
    'UIA_MultipleViewCurrentViewPropertyId',
    'UIA_AutomationFocusChangedEventId', 'UIA_IsPeripheralPropertyId',
    'SynchronizedInputType_RightMouseDown',
    'UIA_BeforeParagraphSpacingAttributeId',
    'UIA_ClassNamePropertyId', 'UIA_DropTarget_DragEnterEventId',
    'AnnotationType_DeletionChange', 'UIA_GridItemColumnPropertyId',
    'UIA_ControlTypePropertyId', 'ZoomUnit_SmallIncrement',
    'NotificationKind_ActionCompleted', 'UIA_LiveSettingPropertyId',
    'UIA_CustomControlTypeId', 'UIA_TransformCanRotatePropertyId',
    'UIA_ToggleToggleStatePropertyId',
    'UIA_StylesFillColorPropertyId', 'UIA_DragIsGrabbedPropertyId',
    'AutomationElementMode',
    'UIA_WindowWindowInteractionStatePropertyId',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'AnnotationType_Sensitive', 'StyleId_Title', 'TextUnit_Character',
    'IUIAutomationNotificationEventHandler', 'UIA_NamePropertyId',
    'UIA_LinkAttributeId', 'UIA_Selection2LastSelectedItemPropertyId',
    'TreeScope_Children', 'UIA_StylesStyleNamePropertyId',
    'NotificationKind_ItemAdded', 'RowOrColumnMajor_Indeterminate',
    'UIA_StylesStyleIdPropertyId', 'UIA_SplitButtonControlTypeId',
    'UIA_SelectionActiveEndAttributeId', 'UIA_FrameworkIdPropertyId',
    'AnnotationType_UnsyncedChange', 'UIA_MenuBarControlTypeId',
    'UIA_BoundingRectanglePropertyId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'UIA_GridColumnCountPropertyId',
    'UIA_RangeValueSmallChangePropertyId',
    'WindowVisualState_Maximized', 'UIA_CaretPositionAttributeId',
    'UIA_ExpandCollapsePatternId',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'UIA_HyperlinkControlTypeId', 'UIA_AutomationIdPropertyId',
    'IUIAutomationSelectionItemPattern',
    'ProviderOptions_ClientSideProvider',
    'UIA_AnnotationAnnotationTypeIdPropertyId', 'IUIAutomation5',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'UIA_IsItalicAttributeId',
    'UIA_StylesExtendedPropertiesPropertyId', 'HeadingLevel_None',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'IUIAutomationValuePattern',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'HeadingLevel2', 'UIA_DescribedByPropertyId',
    ...
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId', 'Assertive',
    'UIA_ValueValuePropertyId', 'DockPosition_Top',
    'UIA_ThumbControlTypeId', 'TextPatternRangeEndpoint_End',
    'WindowVisualState', 'UIA_AnnotationTargetPropertyId',
    'ScrollAmount_LargeDecrement', 'CoalesceEventsOptions',
    'UIA_SpreadsheetItemFormulaPropertyId',
    'StructureChangeType_ChildrenReordered', 'IUIAutomationElement',
    ...
    'IUIAutomationElement3', 'UIA_DocumentControlTypeId',
    'ZoomUnit_LargeIncrement',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId', 'ZoomUnit',
    'AnnotationType_Unknown', 'UIA_MenuClosedEventId',
    'UIA_DockDockPositionPropertyId', 'UIA_AcceleratorKeyPropertyId',
    'UIA_OrientationPropertyId', 'HeadingLevel6',
    'IUIAutomationElement9', 'IUIAutomation3',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_CapStyleAttributeId', 'UIA_WindowControlTypeId',
    'IUIAutomationTextRangeArray', 'TreeTraversalOptions_Default',
    'UIA_HeaderControlTypeId', 'UIA_OutlineStylesAttributeId',
    'AnnotationType_SpellingError', 'PropertyConditionFlags_None',
    'UIA_Transform2ZoomLevelPropertyId', 'UIA_StylesPatternId',
    'UIA_ScrollVerticalViewSizePropertyId', 'TextEditChangeType',
    'StyleId_Heading9', 'IUIAutomation', 'UIA_TableControlTypeId',
    'StructureChangeType', 'UIA_AppBarControlTypeId',
    'UIA_RangeValueValuePropertyId', 'StyleId_Emphasis',
    'IUIAutomationProxyFactoryMapping',
    'UIA_WindowWindowVisualStatePropertyId', 'TextUnit_Document',
    'IUIAutomationBoolCondition', 'TreeScope_None',
    'AnnotationType_Header', 'ScrollAmount_SmallDecrement',
    ...
    'UIA_ControllerForPropertyId', 'IUIAutomationEventHandlerGroup',
    'StyleId_Heading3', 'UIA_ItemTypePropertyId', 'IAccessible',
    'UIA_RadioButtonControlTypeId',
    'UIA_ScrollHorizontalViewSizePropertyId', 'ZoomUnit_NoAmount',
    'UIA_FontNameAttributeId', 'UIA_UnderlineColorAttributeId',
    ...
    'IUIAutomationTextEditPattern', 'IUIAutomationTablePattern',
    'UIA_CultureAttributeId',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'UIA_SpinnerControlTypeId', 'UIA_IsHiddenAttributeId',
    'IUIAutomationElement2', 'NotificationKind_ItemRemoved',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'UIA_AnnotationPatternId', 'UIA_ButtonControlTypeId',
    'IUIAutomationTreeWalker', 'IUIAutomationOrCondition',
    'UIA_Text_TextSelectionChangedEventId',
    'UIA_IsSubscriptAttributeId', 'UIA_MenuOpenedEventId',
    'UIA_AriaRolePropertyId', 'WindowVisualState_Minimized',
    'UIA_SystemAlertEventId',
    'NotificationProcessing_ImportantMostRecent',
    'NavigateDirection_NextSibling', 'OrientationType_Horizontal',
    'UIA_DropTargetPatternId', 'UIA_LocalizedLandmarkTypePropertyId',
    'StyleId_Heading1', 'StructureChangeType_ChildrenBulkRemoved',
    'UIA_RangeValueIsReadOnlyPropertyId',
    'UIA_LandmarkTypePropertyId', 'AnnotationType_GrammarError',
    'AnnotationType_Endnote', 'TextEditChangeType_AutoComplete',
    'TreeScope', 'UIA_IsEnabledPropertyId',
    'UIA_ProviderDescriptionPropertyId',
    'IUIAutomationTransformPattern2', 'IUIAutomationProxyFactory',
    'UIA_SayAsInterpretAsMetadataId', 'UIA_SpreadsheetPatternId',
    'StyleId_BulletedList',
    'UIA_ScrollVerticallyScrollablePropertyId',
    'IUIAutomationElement4', 'UIA_LabeledByPropertyId',
    'UIA_Drag_DragStartEventId', 'UIA_IsPasswordPropertyId',
    'NavigateDirection_LastChild',
    'IUIAutomationPropertyChangedEventHandler',
    'IUIAutomationTextRange', 'HeadingLevel3',
    'UIA_WindowCanMinimizePropertyId', 'UIA_HelpTextPropertyId',
    'UIA_TextControlTypeId', 'UIA_IsSuperscriptAttributeId',
    'TextEditChangeType_AutoCorrect', 'IUIAutomationNotCondition',
    'UIA_TextFlowDirectionsAttributeId', 'UIA_DataItemControlTypeId',
    'UIA_HeaderItemControlTypeId', 'UIA_RotationPropertyId',
    'UIA_FlowsToPropertyId', 'UIA_SelectionItemIsSelectedPropertyId',
    'UIA_TextEditPatternId', 'UIA_NativeWindowHandlePropertyId',
    'UIA_ToolTipOpenedEventId', 'ExpandCollapseState_LeafNode',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'IUIAutomationEventHandler', 'UIA_GridItemRowPropertyId',
    'UIA_GridItemColumnSpanPropertyId',
    'UIA_Transform2CanZoomPropertyId', 'UIA_TabsAttributeId',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'DockPosition_Right', 'UIA_IsStylesPatternAvailablePropertyId',
    'IUIAutomationTextRange3',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'RowOrColumnMajor', 'UIA_WindowCanMaximizePropertyId',
    'UIA_FormLandmarkTypeId',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'UIA_AnimationStyleAttributeId', 'UIA_AriaPropertiesPropertyId',
    'AnnotationType_TrackChanges', 'UIA_SelectionPatternId',
    'ProviderOptions_RefuseNonClientSupport', 'TextUnit_Format',
    'UIA_SemanticZoomControlTypeId', 'SupportedTextSelection_None',
    'PropertyConditionFlags',
    'UIA_IsTransformPattern2AvailablePropertyId',
    'UIA_SearchLandmarkTypeId', 'IUIAutomationProxyFactoryEntry',
    'UIA_MarginLeadingAttributeId', 'Polite',
    'NotificationProcessing_MostRecent',
    'UIA_WindowIsTopmostPropertyId',
    'AnnotationType_CircularReferenceError',
    'UIA_ItemContainerPatternId', 'UIA_MultipleViewPatternId',
    'SupportedTextSelection', 'WindowInteractionState_NotResponding',
    ...
    'UIA_Window_WindowClosedEventId', 'UIA_TabItemControlTypeId',
    'UIA_SeparatorControlTypeId', 'UIA_DragGrabbedItemsPropertyId',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_RangeValueMaximumPropertyId',
    'UIA_IsControlElementPropertyId',
    'UIA_IsTextPatternAvailablePropertyId', 'ZoomUnit_LargeDecrement',
    'NotificationProcessing', 'UIA_EditControlTypeId',
    'AnnotationType_Mathematics', 'UIA_ToolTipControlTypeId',
    'IUIAutomationGridPattern',
    'UIA_ActiveTextPositionChangedEventId', 'UiaChangeInfo',
    'UIA_MenuItemControlTypeId', 'OrientationType_None',
    'UIA_IsDragPatternAvailablePropertyId',
    'NotificationProcessing_CurrentThenMostRecent',
    'TreeTraversalOptions', 'ProviderOptions_UseClientCoordinates',
    'UIA_MainLandmarkTypeId', 'CoalesceEventsOptions_Enabled',
    'AnnotationType_ExternalChange', 'UIA_TreeControlTypeId',
    ...
    'UIA_VisualEffectsPropertyId', 'IUIAutomation2',
    'UIA_IsKeyboardFocusablePropertyId',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'UIA_OverlineStyleAttributeId', 'TextEditChangeType_Composition',
    'UIA_OverlineColorAttributeId', 'IUIAutomationDropTargetPattern',
    'ToggleState_Off', 'AnnotationType_Comment',
    'NavigateDirection_FirstChild', 'IRawElementProviderSimple',
    'UIA_BulletStyleAttributeId', 'UIA_StyleNameAttributeId',
    'UIA_GridItemRowSpanPropertyId', 'UIA_NavigationLandmarkTypeId',
    'UIA_ValuePatternId', 'UIA_DropTarget_DragLeaveEventId',
    'UIA_TransformCanMovePropertyId', 'UIA_IsOffscreenPropertyId',
    'UIA_LegacyIAccessibleValuePropertyId', 'UIA_NotificationEventId',
    'DockPosition_Fill', 'UIA_ForegroundColorAttributeId',
    'TextEditChangeType_None', 'IUIAutomationScrollPattern',
    'UIA_ItemStatusPropertyId',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'IUIAutomationTransformPattern',
    'UIA_IndentationFirstLineAttributeId',
    'ProviderOptions_ProviderOwnsSetFocus',
    'UIA_ScrollBarControlTypeId', 'UIA_UnderlineStyleAttributeId',
    'UIA_TableItemPatternId', 'UIA_IsActiveAttributeId',
    'UIA_IsRequiredForFormPropertyId',
    'UIA_SynchronizedInputPatternId', 'IUIAutomationTogglePattern',
    'UIA_TextPatternId', 'PropertyConditionFlags_IgnoreCase',
    'TextUnit_Line', 'IUIAutomationElement6',
    ...
    'SupportedTextSelection_Multiple', 'Off', 'UIA_GridPatternId',
    'HeadingLevel9', 'SynchronizedInputType_KeyUp',
    'UIA_SliderControlTypeId', 'NotificationKind_Other',
    'IUIAutomationTextRange2',
    'IUIAutomationSynchronizedInputPattern',
    'IUIAutomationSpreadsheetPattern', 'OrientationType_Vertical',
    'TextPatternRangeEndpoint', 'ZoomUnit_SmallDecrement',
    ...
    'UIA_IsTablePatternAvailablePropertyId', 'UIA_FillTypePropertyId',
    'UIA_AutomationPropertyChangedEventId', 'IUIAutomationElement5',
    'UIA_ClickablePointPropertyId', 'UIA_HeadingLevelPropertyId',
    'UIA_TablePatternId', 'UIA_TransformCanResizePropertyId',
    'UIA_TitleBarControlTypeId',
    'UIA_IsInvokePatternAvailablePropertyId',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'UIA_MarginTopAttributeId', 'UIA_TogglePatternId',
    'WindowInteractionState_Running', 'UIA_DropTarget_DroppedEventId',
    'IUIAutomationStylesPattern', 'SupportedTextSelection_Single',
    'UIA_HasKeyboardFocusPropertyId',
    'UIA_IsTogglePatternAvailablePropertyId',
    'UIA_IsDialogPropertyId', 'UIA_StatusBarControlTypeId',
    'IUIAutomationObjectModelPattern', 'UIA_MarginBottomAttributeId',
    'UIA_TransformPatternId', 'UIA_VirtualizedItemPatternId',
    'ProviderOptions_NonClientAreaProvider',
    'CoalesceEventsOptions_Disabled', 'DockPosition_Bottom',
    'AnnotationType_FormatChange', 'UIA_PositionInSetPropertyId',
    'UIA_SelectionPattern2Id', 'TreeScope_Element',
    'IUIAutomationCustomNavigationPattern',
    'WindowInteractionState_ReadyForUserInteraction',
    'UIA_StructureChangedEventId',
    'SynchronizedInputType_LeftMouseDown',
    'UIA_LocalizedControlTypePropertyId', 'UIA_TransformPattern2Id',
    'UIA_IsDataValidForFormPropertyId', 'UIA_StylesShapePropertyId',
    'ToggleState', 'ScrollAmount_LargeIncrement',
    'AutomationElementMode_Full', 'ProviderOptions_OverrideProvider',
    'StyleId_Subtitle', 'ProviderOptions',
    'RowOrColumnMajor_ColumnMajor',
    'UIA_LegacyIAccessibleHelpPropertyId', 'UIA_RangeValuePatternId',
    'UIA_TextEdit_TextChangedEventId',
    'WindowInteractionState_Closing', 'UIA_TreeItemControlTypeId',
    'UIA_MenuControlTypeId', 'NavigateDirection_Parent',
    'UIA_IndentationTrailingAttributeId',
    'UIA_IndentationLeadingAttributeId', 'UIA_IsReadOnlyAttributeId',
    'UIA_Window_WindowOpenedEventId',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'IUIAutomationGridItemPattern',
    'IUIAutomationItemContainerPattern', 'UIA_ToolTipClosedEventId',
    'StyleId_Heading6', 'ToggleState_Indeterminate', 'LiveSetting',
    'UIA_Invoke_InvokedEventId', 'CUIAutomation',
    'StructureChangeType_ChildrenBulkAdded',
    'UIA_DropTargetDropTargetEffectPropertyId',
    'IUIAutomationDockPattern',
    'UIA_SelectionItem_ElementSelectedEventId',
    'UIA_ToolBarControlTypeId',
    'IUIAutomationFocusChangedEventHandler', 'ExtendedProperty',
    'UIA_IsDropTargetPatternAvailablePropertyId', 'OrientationType',
    ...
    'UIA_LiveRegionChangedEventId', 'UIA_AnnotationTypesPropertyId',
    'UIA_TextChildPatternId', 'DockPosition', 'UIA_SummaryChangeId',
    'TextUnit', 'AnnotationType_ConflictingChange',
    'AutomationElementMode_None',
    'TextEditChangeType_CompositionFinalized',
    'UIA_SelectionItemPatternId',
    'UIA_RangeValueLargeChangePropertyId',
    'AnnotationType_DataValidationError', 'StyleId_Heading4',
    ...
    'UIA_TextPattern2Id', 'UIA_DockPatternId',
    'UIA_FontWeightAttributeId', 'IUIAutomationScrollItemPattern',
    'SynchronizedInputType', 'UIA_GridRowCountPropertyId',
    'StyleId_Quote', 'AnnotationType_Highlighted',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'AnnotationType_Footer', 'UIA_CaretBidiModeAttributeId',
    'UIA_CustomLandmarkTypeId', 'UIA_SizePropertyId',
    'UIA_AccessKeyPropertyId', 'UIA_SpreadsheetItemPatternId',
    'UIA_CustomNavigationPatternId', 'StyleId_Heading8',
    'UIA_BackgroundColorAttributeId'
]

_check_version('1.2.0', 1691573272.395523)
